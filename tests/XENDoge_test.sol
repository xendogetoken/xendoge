...
contract testSuite {
    ...
    function checkCalculateMintReward() public {
        ...
        Assert.equal(52864192000000000000000, xenDoge._calculateMintReward(7500000000000000000000000000, 3304012000000000000000000), "Incorrect mint reward calculation");
